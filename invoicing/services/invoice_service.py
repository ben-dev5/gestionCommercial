...
class InvoiceService:
    ...
    def create_invoice(self, contact_id, name, address, city, state, zip_code, siret, email, phone, created_at=None):
        ...
        return self.repo.create_invoice(contact, name, address, city, state, zip_code, siret, email, phone,  created_at)
    ...
    def update_invoice(self, invoice_id, contact_id, name, address, city, state, zip_code, siret, email, phone,  created_at=None):
        """Mettre à jour une facture"""
        self.validate_invoice_data(contact_id, name, address, city, state, zip_code, siret, email, phone)
        contact = self.contact_service.get_contact_by_id(contact_id)
        return self.repo.update_invoice(invoice_id, contact, name, address, city, state, zip_code, siret, email, phone,  created_at)
