...
class SalesOrderLineRepository:
    ...
    def create_sales_order_line(self, sales_order, product, contact_id, price_ht, tax, price_it, quantity, date, genre):
    ...
    def update_sales_order_line(self, sales_order_line_id, sales_order, product, contact_id, price_ht, tax, price_it, quantity, date, genre):
        sales_order_line = SalesOrderLine.objects.get(sales_order_line_id=sales_order_line_id)
        sales_order_line.sales_order_id = sales_order
        sales_order_line.product_id = product
        sales_order_line.contact_id_id = contact_id
