...
class SalesOrderLineRepository:
    ...
    def create_sales_order_line(self, sales_order, product, contact, price_ht, tax, quantity, date, genre):
    ...
    def update_sales_order_line(self, sales_order_line_id, sales_order, product, contact, price_ht, tax, quantity, date, genre):
        sales_order_line = SalesOrderLine.objects.get(sales_order_line_id=sales_order_line_id)
